...
public class Folder {
    ...
    public int sumAll() {
        ...
        int sumFile = calculateAllFileSize2();
    ...
    private int calculateAllFileSize2() {
    ...
    private void calculateAllFileSize() {
        for (int i = 0; i < files.size(); i++) {
    ...
    public int getSizeOfFoldersWithSizeLessThan(int sizeThreshold) {
        int totalSize = 0;
        ...
        for (Folder innerFolder : folders) {
            totalSize += innerFolder.getSizeOfFoldersWithSizeLessThan(sizeThreshold);
        }
